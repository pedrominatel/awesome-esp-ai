...
- Ask whether to run `idf.py reconfigure` after fixing project or component
...
- whether v5 and v6 builds use separate build directories
...
- Build ESP-IDF 6.0 in a separate directory such as `build-v6`; do not reuse
  artifacts generated by the source ESP-IDF version
